...
- [Project 5 - FUSE](#project-5---fuse)
  ...
  - [LARD](#lard)
    ...
    - [Axioms](#axioms)
    - [Format](#format)
    - [Format Explination](#format-explination)
      - [The superblock](#the-superblock)
      - [The I-List](#the-i-list)
      - [The I-Map](#the-i-map)
      - [The D-Pool](#the-d-pool)
  - [readLardfs.py](#readlardfspy)
    - [LARDIMAGE](#lardimage)
    - [getImaps](#getimaps)
    - [getdPools](#getdpools)
    - [IListEntry](#ilistentry)
  - [lardinator3000.py](#lardinator3000py)
    - [Image](#image)
    - [MetaData](#metadata)
    - [INode](#inode)
    - [FileEntry and DirectoryEntry](#fileentry-and-directoryentry)
    - [readIList](#readilist)
    - [readIMap](#readimap)
    - [read](#read)
    ...
    - [writeFile](#writefile)
    - [writeImap and writeInode](#writeimap-and-writeinode)
    - [allocImap](#allocimap)
    - [truncate and unallocateImap](#truncate-and-unallocateimap)
    - [allocInode](#allocinode)
    - [softLinkInode](#softlinkinode)
    - [getNumFreeInodes](#getnumfreeinodes)
    - [getNumFreeImaps](#getnumfreeimaps)
  - [SousTest.py](#soustestpy)
    - [testRead](#testread)
    - [testWrite](#testwrite)
    - [testAllocInode](#testallocinode)
  - [waiter.py](#waiterpy)
    - [Configuration](#configuration)
    - [LardFS](#lardfs)
      - [flush and fsync](#flush-and-fsync)
...
<!-- TOC --><a name="required-software"></a>
### Required Software
...
<!-- TOC --><a name="format-explination"></a>
### Format Explination

<!-- TOC --><a name="the-superblock"></a>
#### The superblock
...
<!-- TOC --><a name="fileentry-and-directoryentry"></a>
...
<!-- TOC --><a name="writeimap-and-writeinode"></a>
...
<!-- TOC --><a name="truncate-and-unallocateimap"></a>
...
<!-- TOC --><a name="reading-directories"></a>
#### Reading Directories
